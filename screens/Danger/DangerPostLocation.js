...
export default function DangerPostLocation({navigation}) {
  ...
  const locationInfo = () => {
    if (region) {
      navigation.navigate('DangerPost', {
  ...
  return (
    <View style={{flex: 0.9}}>
      ...
      <View
        ...
        <TouchableOpacity style={styles.Btn} onPress={locationInfo}>
          <Text style={styles.text}>위치선택</Text>
        </TouchableOpacity>
      </View>
    </View>
  )
